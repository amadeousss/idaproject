<template>
  <div id="root">
    <button @click="$parent.$parent.removeProduct(product.productKey)">
      <svg width="14" height="16" viewBox="0 0 14 16" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M9.20695 5.79688C8.99998 5.79688 8.83224 5.96462 8.83224 6.17158V13.2535C8.83224 13.4604 8.99998 13.6283 9.20695 13.6283C9.41392 13.6283 9.58166 13.4604 9.58166 13.2535V6.17158C9.58166 5.96462 9.41392 5.79688 9.20695 5.79688Z" fill="white"/>
        ...
        <path d="M4.78544 5.79688C4.57848 5.79688 4.41074 5.96462 4.41074 6.17158V13.2535C4.41074 13.4604 4.57848 13.6283 4.78544 13.6283C4.99241 13.6283 5.16015 13.4604 5.16015 13.2535V6.17158C5.16015 5.96462 4.99241 5.79688 4.78544 5.79688Z" fill="white"/>
        <path d="M6.9962 5.79688C6.78923 5.79688 6.62149 5.96462 6.62149 6.17158V13.2535C6.62149 13.4604 6.78923 13.6283 6.9962 13.6283C7.20317 13.6283 7.37091 13.4604 7.37091 13.2535V6.17158C7.37091 5.96462 7.20317 5.79688 6.9962 5.79688Z" fill="white"/>
      </svg>
    </button>
    <div class="product-image" :style="{'background-image': 'url(' + product.imageLink + ')' }">
    </div>
    <h4>{{product.productName}}</h4>
    <p>{{product.productDescription}}</p>
    <h3>{{numberWithSpaces(product.productPrice)}} руб.</h3>
  </div>
</template>
